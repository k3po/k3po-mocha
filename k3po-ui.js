...
var BrowserRunnerConfig = require('./lib/browser/BrowserRunnerConfig.js');
var ScriptBuilder = require("./lib/ScriptRunnerConfig.js");
 ...
 * k3po functionality
 */
module.exports = Mocha.interfaces['k3po-ui'] = function (suite) {
    var suites = [suite];
    var failedTests = 0;
    ...
    suite.on('pre-require', function (context, file, mocha) {
        ...
        context.describe = context.context = function (title, fn) {
            ...
            if (ignoredBrowsers && ignoredBrowsers.indexOf(process.env.browser+" "+process.env.version) !== -1) {
                suite.pending=true;
            }
            fn.call(suite);
            suites.shift();
